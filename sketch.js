...
function draw() {
  ...
  arc(200, 150, diameter0*150, diameter0*150, 330, PI);
  ellipseMode(RADIUS);
  fill(128,128,0);
  //Move on x axis and opening arc by adjusting the diameter1
  arc(diameter1*(0.8), 150, 150, 150, diameter1*(0.005), PI); 
  ellipseMode(RADIUS);
  fill(153,144,255);
  //diameter2 opens arc with radius 280
  arc(400, 150, 150, 150, diameter2*(0.4), PI); 
  ...
  var freq2 = map(diameter1, diameter2, width, 40, 880);    
    osc2.freq(freq2);
    //console.log(freq2);
    
 var freq3 = map(diameter2*10, diameter1, width, 40, 880);
    //sound wave are influenced by both diameter1 and diameter2
    osc3.freq(freq3);
    //console.log(freq3); 
}
